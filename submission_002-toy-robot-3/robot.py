...
def split_command_input(command):
    """
    TODO: Splits the string at the first space character, to get the actual command, as well as the argument(s) for the command
...
def is_int(value):
    """
    TODO: Tests if the string value is an int or not
...
def valid_command(command):
    """
    TODO: Returns a boolean indicating if the robot can understand the command or not
...
def do_help():
    """
    TODO: Provides help information to the user
...
def is_position_allowed(new_x, new_y):
    """
    TODO: Checks if the new position will still fall within the max area limit
...
def update_position(steps):
    """
    TODO: Update the current x and y positions given the current direction, and specific nr of steps
    :param steps:
...
def do_forward(robot_name, steps):
    """
    TODO: Moves the robot forward the number of steps
    :param robot_name:
    :param steps:
...
def do_right_turn(robot_name):
    """
    TODO: Do a 90 degree turn to the right
    :param robot_name:
...
def do_left_turn(robot_name):
    """
    TODO: Do a 90 degree turn to the left
    :param robot_name:
...
def do_sprint(robot_name, steps):
    """
    TODO: Sprints the robot, i.e. let it go forward steps + (steps-1) + (steps-2) + .. + 1 number of steps, in iterations
    :param robot_name:
    :param steps:
...
def handle_command(robot_name, command):
    """
    TODO: Handles a command by asking different functions to handle each command.
...
def history(command, history_appended):
    """
    TODO: updates the history command
    """
...
def replay(history_appended, robot_name, command):
    """
    TODO: handles replay with silent and reverse
    """
...
def robot_start():
    """
    TODO: This is the entry point for starting my robot
    """
